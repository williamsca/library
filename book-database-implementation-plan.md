...
- `search_text` — lowercase concatenation of searchable fields
...
Responsibilities:
1. Fetch CSV from Dropbox shared link
...
function render(bookList) {
  ...
  // Each card shows: cover image, title, author, geo_region, sort_year
}
...
- Rating: Display as stars or simple "4/5"
- Expandable: Click to reveal notes if present
